...
import { getColumns } from './../ybc/list.data';
import { list } from './../ybc/list.api';
import ViewModal from './../ybc/modules/view.vue';
...
../gcyppz/JcPzYpzcscjy.data../gcyppz/JcPzYpzcscjy.api