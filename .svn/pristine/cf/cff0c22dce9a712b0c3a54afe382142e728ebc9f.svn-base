      ...
      switch (permissionMode) {
        ...
        case PermissionModeEnum.BACK:
          ...
          for (let route of routeList) {
            if (route.name !== 'dashboard-analysisParent') continue;
            route.children?.push({
              path: '/dashboard/homePage1',
              name: 'dashboard-homePage1',
              ...
              name: 'dashboard-homePage2',
              component: () => import('/@/views/dashboard/homePage/index_230630.vue'),
              meta: {
                title: '测试首页-230630',
                ignoreAuth: true,
              },
            }, {
              path: '/dashboard/homePage3',
              name: 'dashboard-homePage3',
              component: () => import('/@/views/dashboard/homePage/index_230704.vue'),
              meta: {
                title: '测试首页-230704',
                ignoreAuth: true,
              },
            }, {
              path: '/dashboard/homePage4',
              name: 'dashboard-homePage4',
              component: () => import('/@/views/dashboard/homePage/index_230718.vue'),
              meta: {
                title: '测试首页-230718',
                ignoreAuth: true,
              },
            }, {
              path: '/dashboard/homePage5',
              name: 'dashboard-homePage5',
              component: () => import('/@/views/dashboard/homePage/index_230726.vue'),
              meta: {
                title: '测试首页-230726',
                ignoreAuth: true,
              },
            }, {
              path: '/dashboard/homePage6',
              name: 'dashboard-homePage6',
              component: () => import('/@/views/dashboard/homePage/index_230801.vue'),
              meta: {
                title: '测试首页-230801',
                ignoreAuth: true,
              },
            }, {
              path: '/dashboard/homePage7',
              name: 'dashboard-homePage7',
              component: () => import('/@/views/dashboard/homePage/index_230915.vue'),
              meta: {
                title: '测试首页-230915',
                ignoreAuth: true
              },
