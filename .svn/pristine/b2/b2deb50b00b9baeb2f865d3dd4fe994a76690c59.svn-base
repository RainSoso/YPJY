...
<template>
  <div>
    <BasicModal v-bind="$attrs" @register="register" :title="modalTitle" width="1200px" wrapClassName="j-user-select-modal" @ok="handleOk" destroyOnClose @visible-change="visibleChange">
      <a-row>
