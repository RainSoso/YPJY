<template>
  <Modal v-bind="getBindValue" @cancel="handleCancel">
    ...
    <ModalWrapper
      ...
      :visible="visibleRef"
      :modalFooterHeight="getProps.footer !== undefined && !getProps.footer ? 0 : undefined"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit, attrs }) {
      ...
      function handleHeightChange(height: string, maxHeight: number, isFullScreen: boolean) {
        emit('height-change', height, maxHeight, isFullScreen);
      }
