...
import MPopup from './jeecg/components/MPopup.vue';
import MAreaSelect from './jeecg/components/MAreaSelect.vue';
import MAreaSelectMultiple from './jeecg/components/MAreaSelectMultiple.vue';
import MCategorySelect from './jeecg/components/MCategorySelect.vue';
import MUpload from './jeecg/components/MUpload.vue';
...
componentMap.set('MPopup', MPopup);
componentMap.set('MAreaSelect', MAreaSelect);
componentMap.set('MAreaSelectMultiple', MAreaSelectMultiple);
componentMap.set('MCategorySelect', MCategorySelect);
componentMap.set('MUpload', MUpload);
