...
import { list, deleteOne, batchDelete, getImportUrl, getExportUrl, listMx } from './Rcjgjbxx.api';
...
const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
  tableProps: {
    ...
    beforeFetch(params) {
      ...
      if (route.query?.jcjg_) params.jcjg_ = route.query.jcjg_;
      if (route.query?.year_) params.year_ = route.query.year_;
      return params;
    },
