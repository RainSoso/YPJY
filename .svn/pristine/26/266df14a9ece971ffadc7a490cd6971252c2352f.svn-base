    ...
    <BasicModal v-bind="$attrs" @register="registerModal" title="查看" @ok="handleSubmit" width="60%">
        ...
        <table class="my-table mb-2">
            ...
            <tr>
                ...
                <td>{{ FormData.scph }}</td>
                <td class="text-blue font-600 text-right">生产企业/上市许可持有人</td>
                <td>{{ FormData.scqy }}</td>
            </tr>
            <tr>
                <td class="text-blue font-600 text-right">所属门店</td>
                <td >{{ FormData.ssmd }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">{{  FormData.clyj }}</td>
            </tr><tr>
                <td class="text-blue font-600 text-right">处理情况</td>
                <td colspan="3">{{  FormData.clqk }}</td>
            </tr><tr>
