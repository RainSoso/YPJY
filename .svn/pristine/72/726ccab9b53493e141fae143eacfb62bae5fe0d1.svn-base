...
export default defineComponent({
    ...
    setup() {
        ...
        const panes = ref([{
            key: 'hf', title: '有效', component: 'xzsp', props: { serviceType: 1 }
        }, {
            key: 'zx', title: '无效', component: 'xzsp', props: { serviceType: 2 }
        }, {
            key: 'jjgqzs', title: '即将过期证书', component: 'xzsp', props: { serviceType: 3 }
