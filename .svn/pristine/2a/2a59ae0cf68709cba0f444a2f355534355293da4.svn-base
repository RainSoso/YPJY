...
import { columns, searchFormSchemaZxjc } from './Rcjgjbxx.data';
import { getZxjcbglistPage, deleteOne, batchDelete, getImportUrl, getExportUrl, listMx } from './Rcjgjbxx.api';
...
const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
  tableProps: {
    ...
    api: getZxjcbglistPage,
    columns,
    canResize: false,
    formConfig: {
      labelWidth: 120,
      schemas: searchFormSchemaZxjc,
