...
import { RcjgjbxxListJcry, deleteOne, batchDelete, getImportUrl, getExportUrl, listMx } from './Rcjgjbxx.api';
import { useRoute } from 'vue-router';
import { useGo } from '/@/hooks/web/usePage';
import { propTypes } from '/@/utils/propTypes';

const props = defineProps({
  jcry: propTypes.string,
  dj: propTypes.string
});
