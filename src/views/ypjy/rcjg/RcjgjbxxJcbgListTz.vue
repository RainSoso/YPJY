...
import { listTz, deleteOne, batchDelete, getImportUrl, getExportUrl, listMx } from './Rcjgjbxx.api';
...
const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
  tableProps: {
    ...
    beforeFetch(params) {
      //检查结果统计   图形化页面进入
      if (route.query?.jcjl) params.jcjl = route.query.jcjl;
      if (route.query?.nd) params.nd = route.query.nd;
