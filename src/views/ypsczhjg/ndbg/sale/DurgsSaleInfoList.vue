<template>
  <div>
   ...
   <BasicTable @register="registerTable" class="my-basic-table">
    ...
    <!-- 表单区域 -->
    <DurgsSaleInfoModal @register="registerModal" @success="handleSuccess"></DurgsSaleInfoModal>
  </div>
</template>
...
<script lang="ts" name="ndbg-durgsSaleInfo" setup>
  ...
  import DurgsSaleInfoModal from './modules/DurgsSaleInfoModal.vue'
  import {columns, searchFormSchema} from './DurgsSaleInfo.data';
