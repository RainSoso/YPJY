...
<script lang="ts" name="pz-jcPzZjpz" setup>
  ...
  //注册model
   ...
   const props = defineProps({
    Ypzcscjy: { require: true, type: Object },
   })
  ...
  const { prefixCls,tableContext,onExportXls,onImportXls } = useListPage({
       tableProps:{
         ...
         beforeFetch(params) {
          ...
          if (route.query?.qyExists) params.qyExists = route.query?.qyExists;
          if (route.query?.qyXzqhdm) params.qyXzqhdm = getLikeValue(route.query?.qyXzqhdm);
          return params;
        },
        },
        exportConfig: {
