<template>
  <wsl state="2" :columns="columns" :search="searchFormSchema" sort="updateTime"></wsl>
</template>
<script lang="ts" name="gmpsp-yzb" setup>
...
const columns: BasicColumn[] = [{
  title: '受理编号', dataIndex: 'slbh', width: 160, sorter: true
}, {
  ...
  title: '状态', dataIndex: 'dqbz', width: 75, filters: getDictItemsByCode('sqsx_currentstep').filter(item => item.value != 'YS'),
...
const searchFormSchema: FormSchema[] = [{
  ...
  label: '受理编号', field: 'bh1', component: 'Input'
}, {
