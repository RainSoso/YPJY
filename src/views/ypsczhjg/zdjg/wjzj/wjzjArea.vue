<template>
    <div class="bg-white m-4 p-4">
        <h2 class="text-center text-2xl font-600 p-4">辖区无菌制剂监管情况</h2>
...
function loadData(params = { year: currentYear.value, isJc: 'wjzj' }) {
...
function toPzListPage(item, tagTitle = '', query = {}) {
    go({ path: '/zdjg/wjzjpz', query: { scAreaCode: item.xzqhdm, year: currentYear.value, tagTitle: getAreaName(item.xzqhdm) + (tagTitle ? ' - ' + tagTitle : '') + ' - 无菌制剂', ...query } });
}
