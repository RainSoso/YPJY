...
export function getSearchFormSchema(year: number | string | null = null): FormSchema[] {
  ...
  return [{
    label: '抽样日期', field: 'cyrqRange', component: 'RangePicker'
    , rangeFields: ['cyrq_begin', 'cyrq_end'], colProps: { xxl: { span: 5 } }
  }, 
  // {
  //   label: '所属地市', field: 'cydwssds', component: 'JDictSelectTag', componentProps: { dictCode: 'area_city' }
  //   , colProps: { xxl: { span: 4 } }
  // }
  {
    label: '所属区县',
  ...
  ,
  {
    label: '被抽样单位', field: 'bcydwmc', component: 'JInput', colProps: { xxl: { span: 5 } }
  },
  {
    label: '社会信用代码', labelWidth: 110, field: 'zzdm', component: 'JInput', colProps: { xxl: { span: 5 } }

  }
  , {
    label: '抽样单位', field: 'cydwmc', component: 'JInput', colProps: { xxl: { span: 5 } }
  }, {
    label: '抽验级别', field: 'cyjb', component: 'JDictSelectTag', componentProps: { dictCode: 'CYJB-1', stringToNumber: false, showChooseOption: false }, colProps: { xxl: { span: 5 } }
  }, {
    label: '抽验结果', field: 'jyjg', component: 'JDictSelectTag', componentProps: { dictCode: 'JYJG-1', stringToNumber: false , showChooseOption: false}, colProps: { xxl: { span: 5 } }
  }];
}
