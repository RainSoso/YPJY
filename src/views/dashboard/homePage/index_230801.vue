<template>
	<div ref="bodyEl" class="enter-y my-index">
		<Card class="lg:w-full !p-0 !mx-8px" :loading="loading" :bodyStyle="{ padding: '16px' }">
			<template #title>
				<div class="relative">
			...
			<div class="lg:w-full flex items-stretch justify-items-auto">
				<div class="flex-1 w-0 p-4 bg-blue-500 text-light-50 rounded mr-2">
					<div class="text-center text-xl font-600 mb-4">上市许可持有</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">基础数据</div>
						<div class="text-center mr-4">
							<div class="title">省内药品品种</div>
							<CountTo :startVal="0" :endVal="2418" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">省内药品文号</div>
							<CountTo :startVal="0" :endVal="7097" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">药品上市许可持有人</div>
							<CountTo :startVal="0" :endVal="256" separator="" class="text-xl" />
						</div>
					</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">委托情况</div>
						<div class="text-center mr-4">
							<div class="title">外省委托本省生产药品</div>
							<CountTo :startVal="0" :endVal="67" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">本省委托外省生产药品</div>
							<CountTo :startVal="0" :endVal="230" separator="" class="text-xl" />
						</div>
					</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">文号分类</div>
						<div class="text-center mr-4">
							<div class="title">疫苗</div>
							<CountTo :startVal="0" :endVal="42" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">生物制品(除疫苗)</div>
							<CountTo :startVal="0" :endVal="53" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">多组分生化药</div>
							<CountTo :startVal="0" :endVal="172" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">中药注射剂</div>
							<CountTo :startVal="0" :endVal="18" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">毒麻精放药品</div>
							<CountTo :startVal="0" :endVal="32" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">含兴奋剂药品</div>
							<CountTo :startVal="0" :endVal="322" separator="" class="text-xl" />
						</div>
					</div>
					<div class="flex items-center -mr-4">
						<div class="font-600 w-8 mr-4">监管分类</div>
						<div class="text-center mr-4">
							<div class="title">集采药品</div>
							<CountTo :startVal="0" :endVal="56" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">重点监管药品</div>
							<CountTo :startVal="0" :endVal="180" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">高风险中药饮片</div>
							<CountTo :startVal="0" :endVal="179" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4 max-w-1/7">
							<div class="title">近3年不良反应较为集中药品</div>
							<CountTo :startVal="0" :endVal="33" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">一致性评价药品</div>
							<CountTo :startVal="0" :endVal="33" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">新药</div>
							<CountTo :startVal="0" :endVal="15" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">儿童用药</div>
							<CountTo :startVal="0" :endVal="69" separator="" class="text-xl" />
						</div>
					</div>
				</div>
				<div class="p-4 bg-green-500 text-light-50 rounded ml-2">
					<div class="text-center text-xl font-600 mb-4">药品生产</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">基础数据</div>
						<div class="text-center mr-4">
							<div class="title">药品生产企业</div>
							<CountTo :startVal="0" :endVal="384" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">放射性药品生产企业</div>
							<CountTo :startVal="0" :endVal="3" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">医疗机构制剂单位</div>
							<CountTo :startVal="0" :endVal="80" separator="" class="text-xl" />
						</div>
					</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">许可类型</div>
						<div class="text-center mr-4">
							<div class="title">自产(A类)</div>
							<CountTo :startVal="0" :endVal="273" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">委托(B类)</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">纯委托(B类)</div>
							<CountTo :startVal="0" :endVal="42" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">受托(C类)</div>
							<CountTo :startVal="0" :endVal="60" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">纯受托(C类)</div>
							<CountTo :startVal="0" :endVal="2" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">原料药(D类)</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
					</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">生产情况</div>
						<div class="text-center mr-4">
						...
						<div class="text-center mr-4">
							<div class="title">产能产量</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">多个生产场地</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">跨地市生产</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">外省委托本省生产</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
					</div>
					<div class="flex items-center mb-4 -mr-4">
						<div class="font-600 w-8 mr-4">监管分类</div>
						<div class="text-center mr-4">
							<div class="title">重点监管企业</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
						<div class="text-center mr-4">
							<div class="title">高风险中药饮片企业</div>
							<CountTo :startVal="0" :endVal="104" separator="" class="text-xl" />
						</div>
					</div>
				</div>
		...
		<Card class="lg:w-full !p-0 !mx-8px !mt-0" :loading="loading" :bodyStyle="{ padding: '0' }">
			<template #title>
				<div class="flex items-center">
					<div>工作提醒：</div>
					<div class="flex-1 w-0">
						<Vue3Marquee :pauseOnHover="true" :pauseOnClick="true" :duration="15">
							您有<span class="text-red-500 px-1">0</span>条风险处置需要处理。
						</Vue3Marquee>
					</div>
				</div>
			</template>
		...
		<div class="lg:w-1/3">
			<Card title="药品注册变更情况" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
		...
		<div class="lg:w-1/3">
			<Card title="各类监管对象检查情况" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
		...
		<div class="lg:w-2/3">
			<Card title="各单位监督检查情况" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
					tooltip: { trigger: 'axis', formatter: tooltipFormatter() }, grid: { containLabel: true, top: 20, bottom: 40, left: 20, right: 20 },
		...
		<div class="lg:w-1/3">
			<Card title="案件来源分布" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
		...
		<div class="lg:w-2/3">
			<Card title="各市州不良反应次数" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
		...
		<div class="lg:w-1/3">
			<Card title="各类不良反应次数" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
					tooltip: { trigger: 'item', formatter: tooltipFormatter() },
					series: [{
		...
		<div class="lg:w-1/2">
			<Card title="各市州投诉举报次数" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
					tooltip: { trigger: 'axis', formatter: tooltipFormatter() }, grid: { containLabel: true, top: 20, bottom: 40, left: 20, right: 20 }, legend: { data: ['不良反应', '投诉举报'], bottom: 10 },
					xAxis: { type: 'category', axisLabel: { rotate: 45 }, data: ['武汉', '黄石', '十堰', '宜昌', '襄阳', '鄂州', '荆门', '孝感', '荆州', '黄冈', '咸宁', '随州', '恩施', '天门', '潜江', '仙桃', '神农架'] }, yAxis: { type: 'value' },
					series: [
		...
		<div class="lg:w-1/2">
			<Card title="近期投诉举报较多的事由" :loading="loading" class="h-300px" :bodyStyle="{ padding: '1rem' }">
				<my-echarts :style="{ height: 'calc(100% + 2rem)', margin: '-1rem' }" :options="{
...
<script lang="ts" setup name="dashboard-homePage6">
