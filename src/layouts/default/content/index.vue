<template>
  <div :class="[prefixCls, getLayoutContentMode]" :style="{'--header-height':headerHeightRef+'px'}" v-loading="getOpenPageLoading && getPageLoading">
    <PageLayout />
...
<script lang="ts">
  ...
  import { useLayoutHeight, useContentViewHeight } from './useContentViewHeight';
