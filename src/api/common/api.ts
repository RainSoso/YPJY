...
enum Api {
  ...
  getCategoryItemByCode = '/sys/category/getDictItemByCode',
  getAttachmentList = '/sys/attachment/list',
  deleteAttachment = '/sys/attachment/delete',
  findDepartTreeList = '/sys/sysDepart/findTreeList',
  findUserPageList = '/sys/user/findPageList'
}
...
export const getCategoryItemByCode = (params) => {
  return defHttp.get({ url: Api.getCategoryItemByCode, params })
};
/**
 * 文件上传
 */
...
export const attachmentUploadUrl = `${baseUploadUrl}/sys/attachment/upload`;

export const getAttachmentList = (params) => {
  return defHttp.get({ url: Api.getAttachmentList, params })
};

export const deleteAttachment = (params) => {
  return defHttp.delete({ url: Api.deleteAttachment, params }, { joinParamsToUrl: true })
}

export const findDepartTreeList = (params, config?) => {
  return defHttp.get({ url: Api.findDepartTreeList, params }, config)
}

export const findUserPageList = (params, config?) => {
  return defHttp.get({ url: Api.findUserPageList, params }, config)
}
